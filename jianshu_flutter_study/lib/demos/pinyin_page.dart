...
class PinyinPage extends StatefulWidget {
  PinyinPage(this.title, {Key key}) : super(key: key);
  final String title;
...
class _PinyinPageState extends State<PinyinPage> {
  ...
  //改变文字
  void _textChange(String inputText) {
  ...
  void convertToPinyin(String text) {
    switch (_convertType) {
      ...
      case TYPE_SIMPLIFIED:
        _pinyinResult = ChineseHelper.convertCharToSimplifiedChinese(text);
        break;
